            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <asp:UpdatePanel ID="udButton" runat="server">
                        <ContentTemplate>
                            <asp:Button ID="btnThem" runat="server" Text="Thêm" CssClass="btn btn-primary" OnClientClick="DisplayLoadingIcon();" />
                            <asp:Button ID="btnChiTiet" runat="server" Text="Chi tiết" CssClass="btn btn-primary"  OnClientClick="DisplayLoadingIcon();" />
                            <asp:Button ID="btnXoa" runat="server" Text="Xóa" CssClass="btn btn-primary" OnClientClick="DisplayLoadingIcon();" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            </div>
            <div class="form-group table-responsive">
                <dx:ASPxGridView ID="grvTracNghiem" runat="server" ClientInstanceName="grvTaiKhoan" KeyFieldName="account_id" Width="100%">
                    <Columns>
