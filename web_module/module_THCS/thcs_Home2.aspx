        ...
        <div class="block-body">
            <div id="section-class">
                <a id="id_Lop6" runat="server" href="/app-danh-muc-khoi-thcs-6" onclick="DisplayLoadingIcon()" class="class-item color lock-button">
                    ...
                    <i class="fa fa-lock lock-icon" aria-hidden="true" id="iconLock1" runat="server"></i>
                    ...
                    <i class="fa fa-lock lock-icon" aria-hidden="true" id="iconLock2" runat="server"></i>
                    ...
                    <i class="fa fa-lock lock-icon" aria-hidden="true" id="iconLock3" runat="server"></i>
